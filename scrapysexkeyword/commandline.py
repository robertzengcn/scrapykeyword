...
def get_command_line(only_print_help=False):
    """
    Parse command line arguments when scrapykeyword is used as a CLI application.

    Returns:
        The configuration as a dictionary that determines the behaviour of the app.
    """

    parser = argparse.ArgumentParser(prog='scrapykeyword',
                                     description='grab keywords from adult web site',
                                     epilog='Scrapykeyword {version}. '
